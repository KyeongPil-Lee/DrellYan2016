...
generator.jobName = "DYReweightHist_MCStat_Uniform" # -- used for workspace name
generator.classCodePath = "NNLOReweighting/v03_aMCNLOStatCheck/v01_UniformBin/MakeHist_aMCNLO_uniformBin.h"
